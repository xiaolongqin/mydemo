...
public class QueryTableUtil {
    ...
    public static String createVisitTable(String realTableName){
        String createSql="CREATE TABLE "+realTableName+"(\n" +
                ...
                "`page_id`  bigint(20) NOT NULL COMMENT '页面id：该次行为访问的页面id' ,\n" +
                "`page_action_id`  bigint(20) NOT NULL COMMENT '页面定义行为按钮ID：该次行为访问的按钮id' ,\n" +
    ...
    public static String createLogTable(String realTableName){
        String createSql="CREATE TABLE "+realTableName+" (\n" +
                ...
                "`post_value`  varchar(600) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '请求参数值' ,\n" +
                "`return_value`  varchar(600) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '返回值' ,\n" +
                "`add_time`  bigint(20) NOT NULL COMMENT '记录添加时间：时间戳' ,\n" +
                "PRIMARY KEY (`id`)\n" +
                ")\n" +
                "ENGINE=MyISAM\n" +
