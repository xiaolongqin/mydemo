...
public class JsonHelp {
    ...
    public static String buildSuccessByPage(int totalPage,String data){
        return new StringBuilder().append("{\"state\":true,\"msg\":null,").append("\"totalPage\":").append(totalPage).append(",").append("\"data\":").append(data).append("}").toString();
    }
