...
$(function() {
	...
	$('#reg').click(function(){
		window.location.href = "/myMusic/register.jsp";
	});
	$('#user').click(function(){
		window.location.href = "/myMusic/User.jsp";
	});
...
<body style="width: 100%">
	<div style="height: 50px; background: black;">
		...
		<span id="userlogin"
			style="color: #fefefe; font-size: 15px; font-style: inherit; margin-left: 550px; cursor: pointer;">登陆</span>
			<span id="exitlogin" 
			style="color: #fefefe; font-size: 15px; font-style: inherit; margin-left: 550px; cursor: pointer; display: none;">注销</span>
		<span id="reg"
